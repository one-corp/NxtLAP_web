const faqData = [
  ...
  {
    "id": 3,
    "question": "Which motorsports do you cover?",
    "answer": "Currently, we focus on major motorsport events such as Formula 1, MotoGP, and endurance racing, with plans to expand into other racing categories in the future."
  },
  {
    "id": 4,
  ...
  {
    "id": 5,
    "question": "Do you provide live race predictions?",
    "answer": "Yes, we provide AI-driven predictions based on pre-race analysis and live data streams. Our models update predictions as the race progresses."
  },
  {
    "id": 6,
    "question": "How accurate are your AI predictions?",
    "answer": "While no prediction system is 100% accurate, our AI models are trained on historical race data and achieve high reliability by identifying patterns in driver and car performance."
  },
  {
    "id": 7,
  ...
  },
  {
    ...
    "answer": "Yes, you can subscribe to our newsletter to receive the latest race predictions, AI insights, and feature updates directly in your inbox."
  },
  {
    "id": 9,
    "question": "How often is the data updated?",
    "answer": "Data is updated in real time during races and regularly after every event to ensure users always get fresh and accurate insights."
  },
  {
    "id": 10,
