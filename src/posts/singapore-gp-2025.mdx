...
With just a few rounds to go, the Drivers' title remains wide open — and after the heat and chaos of Marina Bay, the championship fight looks set to go down to the wire.